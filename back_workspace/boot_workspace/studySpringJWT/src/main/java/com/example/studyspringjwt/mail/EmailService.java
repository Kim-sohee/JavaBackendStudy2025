...
public class EmailService {
    ...
    public boolean sendEmail(String to, String subject, String content, String link) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);

            String emailContent = buildEmailTemplate(subject, content, link);
    ...
    private String buildEmailTemplate(String subject, String content, String link) {
        ...
        if (link != null && !link.isEmpty()) {
            emailBody += "<a href=\"" + link + "\" class=\"btn\">비밀번호 재설정</a>";
        }
