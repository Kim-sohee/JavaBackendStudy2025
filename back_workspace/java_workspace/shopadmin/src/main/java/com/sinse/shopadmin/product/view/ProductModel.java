...
public class ProductModel extends AbstractTableModel{
	...
	public String getColumnName(int col) {
		return column[col];	//컬럼 제목
	}
	
	//row는 층수를 결정한다, col은 0번째 무얼 1번째 무엇을 가져올 지 조건문으로 내가 원하는 속성 사용
	public Object getValueAt(int row, int col) {
		...
		switch(col) { 
			...
			case 5:value = Integer.toString(product.getProduct_id()); break;
