...
//				g.fillRect(0, 0, this.getPreferredSize().getSize().width, this.getPreferredSize().getSize().height);
		...
		p_wrapper.setPreferredSize(new Dimension(Config.SHOP_MAIN_WIDTH-300, Config.SHOP_MAIN_HEIGHT-Config.UTIL_HEIGHT-Config.NAVI_HEIGHT));
		...
		p_big.setPreferredSize(new Dimension(p_img.getPreferredSize().getSize().width-20, p_img.getPreferredSize().getSize().height-60));
		...
		setPreferredSize(new Dimension(Config.SHOP_MAIN_WIDTH, Config.SHOP_MAIN_HEIGHT-Config.UTIL_HEIGHT-Config.NAVI_HEIGHT));
