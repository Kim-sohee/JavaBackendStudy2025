...
public class MemberJoin extends Page{
	...
	public MemberJoin(AppMain appMain) {
		...
		setPreferredSize(new Dimension(Config.SHOP_MAIN_WIDTH, Config.SHOP_MAIN_HEIGHT-Config.NAVI_HEIGHT-Config.UTIL_HEIGHT));
		setVisible(true);
	}
...
//			mailSender.send(member.getEmail(), "회원가입 축하드립니다.", "저희 회원이 되어 주셔서 감사합니다.");
			mailSender.sendHtml(t_email.getText(), "회원가입 축하드립니다.", "저희 회원이 되어 주셔서 감사합니다.");
